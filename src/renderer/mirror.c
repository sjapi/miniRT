...
/*   Updated: 2025/07/24 00:27:28 by 032zolotarev     ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_color	compute_shadow_ray(t_color obj_col, t_light *l, t_hit *p_hit, t_rt *rt);
...
t_color	compute_mirror(t_color obj_col, t_light *l, t_hit *p_hit, t_rt *info)
{
	...
	if (find_hit(&ray, info->scene, &hit))
	{
		...
		return (compute_shadow_ray(obj_col, l, &hit, info));
	}
