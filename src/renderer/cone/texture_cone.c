...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/24 13:47:47 by azolotar          #+#    #+#             */
/*   Updated: 2025/07/24 14:00:02 by azolotar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	cone_uv(t_hit *hit, float *u, float *v)
{
	t_vec3	p;
	t_vec3	axis_p;
	float	height;
...
static t_color	cone_get_pixel(t_texture *t, float u, float v)
{
	int		sx;
	int		sy;
	char	*pixel;
